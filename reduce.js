...
const countNegativeNumbers = function (numbers) {
  return numbers.reduce(counter, 0);
};

// 10 ---------------------------- Sum Of Even Squares ----------------------------

// const numbers = [1, 2, 3, 4];

const findSumOfEvenSquares = function (numbers) {
  const squaresOfevenNumbers = numbers.filter(isEven).map(square);

  return squaresOfevenNumbers.reduce(add, 0);
};
